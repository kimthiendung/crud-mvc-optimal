 ...
 */
exports.DOMAIN = {
    BASE : "http://admin.hadarone.com",
    API :  "http://api.hadarone.com",
    SSL_API :  "https://api.hadarone.com",
    STATIC: "http://static.hadarone.com",
    ADS_CDN: "http://static.hadarone.com/ads/video",
    FTP_VIDEO: {
    	HOST: "127.0.0.1",
        PORT: 21, 
        USER: "adcdn", 
...
/**
 * Log Hourly log files kept for 1 month
 */
exports.LOG = {
    "appenders": [{
        "category":"Log",
        "filename": "temp/dev-dd-hh",
        "type": "dateFile",
        "pattern": "--dd-hh.log",
